...
- El boton flotante abre el chat web de PARMUX dentro de la landing. El visitante puede elegir una ruta o escribir libremente sin abandonar el sitio.
- El chat usa el endpoint productivo `https://automation.parmux.com/webhook/parmux-web-chat`, hace una calificacion breve y finita, y termina en la ficha de diagnostico o en el WhatsApp oficial. No debe volver a mostrar indefinidamente el menu inicial.
